...
bool CD3DTexture::DrawImage( CD3DDevice * pD3DDevice, cCPoint ptRotationOffset, FLOAT fRadian, CHAR chDirection, INT nXDest, INT nYDest )
{
	assert( pD3DDevice!= NULL );
	if ( pD3DDevice == NULL ) return false;
...
bool CD3DTexture::DrawImage( CD3DDevice * pD3DDevice, cCPoint ptRotationOffset, FLOAT fRadian, CHAR chDirection, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource )
{
	assert( pD3DDevice!= NULL );
	if ( pD3DDevice == NULL ) return false;
...
bool CD3DTexture::DrawImage( CD3DDevice * pD3DDevice, cCPoint ptRotationOffset, FLOAT fRadian, CHAR chDirection, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource, INT nSourceWidth, INT nSourceHeight )
{
	assert( pD3DDevice!= NULL );
	if ( pD3DDevice == NULL ) return false;
...
bool CD3DTexture::DrawImage( CD3DDevice * pD3DDevice, cCPoint ptRotationOffset, FLOAT fRadian, CHAR chDirection, INT nXDest, INT nYDest, BYTE cbAlpha )
{
	assert( pD3DDevice!= NULL );
	if ( pD3DDevice == NULL ) return false;
...
bool CD3DTexture::DrawImage( CD3DDevice * pD3DDevice, cCPoint ptRotationOffset, FLOAT fRadian, CHAR chDirection, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource, BYTE cbAlpha )
{
	assert( pD3DDevice!= NULL );
	if ( pD3DDevice == NULL ) return false;
...
bool CD3DTexture::DrawImage( CD3DDevice * pD3DDevice, cCPoint ptRotationOffset, FLOAT fRadian, CHAR chDirection, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource, INT nSourceWidth, INT nSourceHeight, BYTE cbAlpha )
{
	assert( pD3DDevice!= NULL );
	if ( pD3DDevice == NULL ) return false;
