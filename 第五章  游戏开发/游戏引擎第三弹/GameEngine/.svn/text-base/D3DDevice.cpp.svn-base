...
VOID CD3DDevice::FillRect( cCRect rcRect, D3DCOLOR D3DColor )
{
...
{
	cCRect rcRect(nXPos,nYPos,nXPos+nWidth,nYPos+nHeigth);

	FillRect(rcRect,D3DColor);
}

VOID CD3DDevice::DrawRect( cCRect rcRect, D3DCOLOR D3DColor )
{
