...
CD3DSpritePtrArray		m_D3DSpritePtrArray;				//精灵数组
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest )
{
	...
	m_pISprite->Draw(m_pITexture, cCRect(0,0,m_ImageSize.cx,m_ImageSize.cy), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),0xFFFFFFFF);
	m_pISprite->Flush();
	m_pISprite->End();
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource )
{
	...
	//绘画位置
	m_pISprite->Begin(D3DXSPRITE_ALPHABLEND);
	m_pISprite->Draw(m_pITexture, cCRect(nXSource,nYSource,nXSource+nDestWidth,nYSource+nDestHeight), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),0xFFFFFFFF);
	m_pISprite->Flush();
	m_pISprite->End();
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource, INT nSourceWidth, INT nSourceHeight )
{
	...
	//绘画位置
	m_pISprite->Begin(D3DXSPRITE_ALPHABLEND);
	m_pISprite->Draw(m_pITexture, cCRect(nXSource,nYSource,nXSource+nSourceWidth,nYSource+nSourceHeight), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),0xFFFFFFFF);
	m_pISprite->Flush();
	m_pISprite->End();
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest, D3DCOLOR Color )
{
	...
	//绘画位置
	m_pISprite->Begin(D3DXSPRITE_ALPHABLEND);
	m_pISprite->Draw(m_pITexture, cCRect(nXDest,nYDest,nXDest+m_ImageSize.cx,nYDest+m_ImageSize.cy), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),Color);
	m_pISprite->Flush();
	m_pISprite->End();
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource, D3DCOLOR Color )
{
	...
	//绘画位置
	m_pISprite->Begin(D3DXSPRITE_ALPHABLEND);
	m_pISprite->Draw(m_pITexture, cCRect(nXSource,nYSource,nXSource+nDestWidth,nYSource+nDestHeight), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),Color);
	m_pISprite->Flush();
	m_pISprite->End();
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest, BYTE cbAlpha )
{
	...
	//绘画位置
	m_pISprite->Begin(D3DXSPRITE_ALPHABLEND);
	m_pISprite->Draw(m_pITexture, cCRect(0,0,m_ImageSize.cx,m_ImageSize.cy), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),D3DCOLOR_ARGB(cbAlpha,255,255,255));
	m_pISprite->Flush();
	m_pISprite->End();
...
bool CD3DSprite::DrawImage( CD3DDevice * pD3DDevice, INT nXDest, INT nYDest, INT nDestWidth, INT nDestHeight, INT nXSource, INT nYSource, BYTE cbAlpha )
{
	...
	//绘画位置
	m_pISprite->Begin(D3DXSPRITE_ALPHABLEND);
	m_pISprite->Draw(m_pITexture, cCRect(nXSource,nYSource,nXSource+nDestWidth,nYSource+nDestHeight), &D3DXVECTOR3(0,0,0), &D3DXVECTOR3(0,0,0),D3DCOLOR_ARGB(cbAlpha,255,255,255));
	m_pISprite->Flush();
	m_pISprite->End();
